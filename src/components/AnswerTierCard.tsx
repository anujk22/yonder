    ...
    <Entrance index={index}>
      ...
      >
        <View style={styles.topRow}>
          <Text style={[type.mono, styles.eyebrow, { color: theme.inkSoft }]}>
            {EYEBROWS[kind]}
          </Text>
        ...
        <Text
          style={[
            isDispatch ? type.title : type.heading,
            styles.headline,
            isDispatch && styles.dispatchHeadline,
            { color: foreground },
          ]}
        ...
        {observedAt !== undefined && ttlSeconds !== undefined ? (
          ...
          <Text style={[type.mono, styles.meta, { color: theme.inkSoft }]}>
            {subtitle}
          </Text>
        ) : null}

        {isDispatch && observersNearby !== undefined ? (
          <Text style={[type.mono, styles.reason, { color: theme.inkSoft }]}>
            {observersNearby} observers within 5 minutes
          </Text>
        ) : null}
      </Pressable>
    </Entrance>

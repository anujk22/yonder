...
export function Scout({
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 64 64"
      accessibilityLabel="Yonder scout"
      accessibilityRole="image"
    >
      <Path
        d="M32 1 38 9 48 5 50 16 61 19 56 29 63 37 53 43 53 55 41 54 34 63 26 55 15 59 12 48 2 44 7 33 1 24 12 18 13 7 25 10Z"
        fill={background}
      />
      <Path
        d="M16 25c0-6 12-6 12 0v13c0 6-12 6-12 0ZM35 25c0-6 12-6 12 0v13c0 6-12 6-12 0Z"
        fill={color}
      />
      <Circle cx={23} cy={27} r={2.7} fill={background} />
      <Circle cx={42} cy={27} r={2.7} fill={background} />
    </Svg>
  );
}
      ...
      <View style={{ paddingTop: insets.top, backgroundColor: theme.bg }}>
        <View style={styles.mobileBar}>
          <MotionPressable
            ...
            accessibilityLabel="Yonder home"
            onPress={() => router.navigate("/")}
            style={styles.wordmark}
          >
            <Scout size={31} />
            <Text style={[styles.mobileLogo, { color: theme.ink }]}>
              yonder.
            </Text>
          </MotionPressable>
          <MotionPressable
  ...
  return (
    ...
    >
      <View style={[styles.headerInner, !wide && { paddingHorizontal: 20 }]}>
        ...
        >
          <Scout size={34} />
          <Text style={[styles.logo, { color: theme.ink }]}>
            yonder<Text style={{ color: theme.fresh }}>.</Text>
          </Text>
        </Pressable>
        {wide && (
...
const styles = StyleSheet.create({
  ...
  previewText: { fontFamily: font.ui600, fontSize: 10, letterSpacing: 0.2 },
  ...
  logo: { fontFamily: font.black, fontSize: 32, letterSpacing: -1.7 },
  ...
  demo: { alignItems: "center", paddingVertical: 7, paddingHorizontal: 12 },
  demoText: {
  ...
  mobileNav: { flexDirection: "row", justifyContent: "center", gap: 18 },
});
